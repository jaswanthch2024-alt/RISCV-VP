...
CPURV32P2::CPURV32P2(sc_core::sc_module_name const& name, BaseType PC, bool debug)
    ...
    logger->info("Created CPURV32P2 (2-stage pipelined) CPU for VP");
    std::cout << "Created CPURV32P2 (2-stage pipelined) CPU for VP" << std::endl;
}
